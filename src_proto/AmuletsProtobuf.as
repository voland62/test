package  {
	...
	public dynamic final class AmuletsProtobuf extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const AMULETS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("AmuletsProtobuf.amulets", "amulets", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return AmuletProtobuf; });
