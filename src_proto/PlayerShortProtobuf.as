package  {
	...
	public dynamic final class PlayerShortProtobuf extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const BOT:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PlayerShortProtobuf.bot", "bot", (13 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 13:
					if (bot$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayerShortProtobuf.bot cannot be set twice.');
					}
					++bot$count;
