package com.onlyplay.slotmatch3.components.games.elements.scroller
{
	...
	public class SimpleScrollBar extends alternativa.gui.controls.scrollBar.ScrollBar {


		var _scrollBarWidth:int = 6;
...
//			scroller.mouseEnabled = true;
			...
			var simpleBt:SimpleScrollButton = new SimpleScrollButton();
			simpleBt.mouseEnabled = true;
			
			thumb = simpleBt;//scroller;
...
//			addChild(downButton);
		...
		override protected function draw():void {
			...
			if (thumbHeight < _scrollBarWidth) {
				_thumb.height = _scrollBarWidth;
			} else {
