package com.onlyplay.slotmatch3.components.games.elements.tab
{
	 ...
	 * 
	 */	
	public class RoomStretchBitmapOffset extends GUIobject {
		...
		public function RoomStretchBitmapOffset(texture:BitmapData, leftEdgeWidth:int, rightEdgeWidth:int, topEdgeHeight:int, bottomEdgeHeight:int, drawMiddleCenter:Boolean, offsetTop:int = 0, offsetRight:int = 0, offsetLeft:int = 0, offsetBottom:int = 0) {
