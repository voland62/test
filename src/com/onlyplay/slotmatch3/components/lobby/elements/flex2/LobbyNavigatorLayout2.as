...
public class LobbyNavigatorLayout2 extends AnimationNavigatorLayoutBase implements INavigatorLayout
{
     ...
     */    
    public function LobbyNavigatorLayout2():void
    {
    ...
    {
		//log("LobbyNavigatorLayout2.updateDisplayList(unscaledWidth, unscaledHeight)");
